...
export const DebateView = ({
  ...
  return <div className="space-y-8">
      <ConclusionSection statement={debate.statement} argumentsFor={debate.argumentsFor} argumentsAgainst={debate.argumentsAgainst} />
      ...
      <div className="flex flex-col lg:flex-row gap-6 mt-8">
        ...
        <div className={cn("transition-all duration-300 ease-in-out relative", expandedSide === "for" ? "lg:w-full" : expandedSide === "against" ? "lg:hidden" : "lg:flex-1")}>
          <div className="border border-for-border bg-for-bg p-6 space-y-4">
            ...
            e.stopPropagation();
            onAddArgument("for");
          }} variant="outline" className="w-full font-sans text-xs uppercase tracking-wider mt-4 hover:bg-for-hover" disabled={addingArgumentSide === "for"}>
              + Add Argument
            </Button>
          </div>
        </div>
        ...
        <div className={cn("transition-all duration-300 ease-in-out relative", expandedSide === "against" ? "lg:w-full" : expandedSide === "for" ? "lg:hidden" : "lg:flex-1")}>
          ...
          }} variant="outline" className="w-full font-sans text-xs uppercase tracking-wider mt-4 hover:bg-against-hover" disabled={addingArgumentSide === "against"}>
              + Add Argument
            </Button>
          </div>
        </div>
