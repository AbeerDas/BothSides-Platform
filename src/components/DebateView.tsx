  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        ...
        >
          {hoveredSide === "for" && !expandedSide && (
            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-foreground text-background px-3 py-1 text-xs font-sans rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              Expand
            </div>
          )}
        ...
        >
          {hoveredSide === "against" && !expandedSide && (
            <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-foreground text-background px-3 py-1 text-xs font-sans rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              Expand
            </div>
          )}
